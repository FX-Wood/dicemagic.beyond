...
class ThemeWatcher {
    ...
    static deathSavesSVG(color) { return `"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20id%3D'Layer_1'%20viewBox%3D'0%200%2015.9%2018.6'%3E%0D%0A%20%20%3Cstyle%3E%0D%0A%20%20%20%20.st2%7Bfill%3A%23fff%7D%0D%0A%20%20%3C%2Fstyle%3E%0D%0A%20%20%3Cpath%20fill%3D'${encodeURI(color)}'%20d%3D'M15.3%208.1h-.1v-.2C15.2%203.5%2011.9%200%208%200S.8%203.5.8%207.8V8H.6c-.6.2-.8%201.1-.5%202.1.3%201%201%201.6%201.6%201.5l.7%201.1c.5%202.9%202.8%205.8%205.6%205.8s5.1-3%205.6-5.8l.7-1.1c.6.1%201.2-.5%201.5-1.5.3-.9.1-1.9-.5-2z'%2F%3E%0D%0A%20%20%3Cpath%20class%3D'st2'%20d%3D'M10.4%2013.9c0%201.3-1%200-2.3%200s-2.3%201.3-2.3%200%201-2.3%202.3-2.3%202.3%201%202.3%202.3z'%2F%3E%0D%0A%20%20%3Cpath%20class%3D'st2'%20transform%3D'rotate%28135%205%208%29'%20d%3D'M4.6%205.8h.7v4.5h-.7z'%2F%3E%0D%0A%20%20%3Cpath%20class%3D'st2'%20transform%3D'rotate%28-135%205%208%29'%20d%3D'M4.6%205.8h.7v4.5h-.7z'%2F%3E%0D%0A%20%20%3Cpath%20class%3D'st2'%20transform%3D'rotate%28135%2011%208%29'%20d%3D'M10.6%205.8h.7v4.5h-.7z'%2F%3E%0D%0A%20%20%3Cpath%20class%3D'st2'%20transform%3D'rotate%28-135%2011%208%29'%20d%3D'M10.6%205.8h.7v4.5h-.7z'%2F%3E%0D%0A%3C%2Fsvg%3E"`}
    static deathSavesSmallSVG(color) { return `"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20id%3D'Layer_1'%20viewBox%3D'0%200%2015.9%2018.6'%3E%3Cstyle%3E.st2%7Bfill%3A%23000%7D%3C%2Fstyle%3E%3Cpath%20d%3D'M15.3%208.1h-.1v-.2C15.2%203.5%2011.9%200%208%200S.8%203.5.8%207.8V8H.6c-.6.2-.8%201.1-.5%202.1.3%201%201%201.6%201.6%201.5l.7%201.1c.5%202.9%202.8%205.8%205.6%205.8s5.1-3%205.6-5.8l.7-1.1c.6.1%201.2-.5%201.5-1.5.3-.9.1-1.9-.5-2z'%20fill%3D'%23fff'%2F%3E%3Cpath%20class%3D'st2'%20d%3D'M10.4%2013.9c0%201.3-1%200-2.3%200s-2.3%201.3-2.3%200%201-2.3%202.3-2.3%202.3%201%202.3%202.3z'%2F%3E%3Cpath%20transform%3D'rotate%28135%205%208%29'%20class%3D'st2'%20d%3D'M4.6%205.8h.7v4.5h-.7z'%2F%3E%3Cpath%20transform%3D'rotate%28-135%205%208%29'%20class%3D'st2'%20d%3D'M4.6%205.8h.7v4.5h-.7z'%2F%3E%3Cpath%20transform%3D'rotate%28135%2011%208%29'%20class%3D'st2'%20d%3D'M10.6%205.8h.7v4.5h-.7z'%2F%3E%3Cpath%20transform%3D'rotate%28-135%2011%208%29'%20class%3D'st2'%20d%3D'M10.6%205.8h.7v4.5h-.7z'%2F%3E%3C%2Fsvg%3E"`}
    injectNewTheme(color = this.color) {
        ...
        this.styleSheet.insertRule(`@font-face { font-family: 'Cinzel Decorative'; font-style: normal; font-weight: 400; src: url('${chrome.runtime.getURL('fonts/cinzel-decorative-v7-latin-regular.woff2')}') format('woff2') }`)
        ...
        // death saves (in character sheet)
        this.styleSheet.insertRule(`.death-save-mouseover:hover > div:first-child:before { background-image: url(${this.constructor.deathSavesSVG(color)}) }`) // sad face icon
        this.styleSheet.insertRule(`.death-save-mouseover:hover { color: ${color}; font-weight: bolder; }`)
        this.styleSheet.insertRule(`.death-save-mouseover:hover + span { color: ${color}; font-weight: bolder; }`) // 'death saves' at bottom of box
        this.styleSheet.insertRule(`.death-save-mouseover:hover .ct-health-summary__deathsaves--fail .ct-health-summary__deathsaves-mark--inactive { box-shadow: inset 0 0 12px 0 #d24040 }`)
        this.styleSheet.insertRule(`.death-save-mouseover:hover .ct-health-summary__deathsaves--success .ct-health-summary__deathsaves-mark--inactive { box-shadow: inset 0 0 12px 0 #40d250 }`)
        // death saves (in sidebar)
